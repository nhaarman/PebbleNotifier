...
public class DebugOrmLiteModule {

    @Provides
    @Singleton
    OrmManager provideOrmManager(@NotNull final DebugOrmLiteDatabaseHelper debugOrmLiteDatabaseHelper) {
        return debugOrmLiteDatabaseHelper;
    }
}
